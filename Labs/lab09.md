...
[Download the starter code provided here](https://github.com/braedynl/CSE232/raw/main/.assets/downloads/lab09.zip). Your task is to create an implementation file (named "math_vector.cpp") that provides the algorithm for all of the member functions shown below (and inside the header file).
