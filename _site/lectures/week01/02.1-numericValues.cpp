...
int main(int argc, char* argv[]){
  ...
  cout << "Digits in matissa, float:"<<numeric_limits<float>::digits<<endl<<endl;
  ...
  cout << "Digits in matissa, double:"<<numeric_limits<double>::digits<<endl<<endl;
  ...
  cout << "Digits in matissa, long double:"<<numeric_limits<long double>::digits<<endl;
}
